...
## Ingestion
    - Indexing : generate and store metadata about data sources. For example, if we have an employee table with columns [first_name,last_name,email,make,title,salary],
