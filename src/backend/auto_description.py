...
def describe_table(input):
    ...
    resp = gen1(f"The following is a table. Look at the columns and infer what the table is about. Return just the description - as detailed as possible, but keep it straight to the point: {input}")
