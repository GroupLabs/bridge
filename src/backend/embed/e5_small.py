...
if __name__ == "__main__":
    ...
    # takes the second part (after ':') of every string before index 1
    # and embeds it with embed_query
    # does the same with passage after index 1, then adds the two lists together
