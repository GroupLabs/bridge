...
import { VisualizeDataResults } from './visualize-data-results'
...
export function VisualizeDataSection({ result }: SearchSectionProps) {
      ...
      {!pending && data ? (
        <>
          ...
          <Section title="Data Visualization">
            <VisualizeDataResults results={searchResults.results} />
          </Section>
        </>
      ) : (
