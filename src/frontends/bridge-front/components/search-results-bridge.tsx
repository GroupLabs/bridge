...
import { BridgeSearchResultItem } from '@/lib/types'

export interface BridgeSearchResultsProps {
  results: BridgeSearchResultItem[]
}

export function SearchResultsBridge({ results = [] }: BridgeSearchResultsProps) {
