...
def llm(prompt, context=[], model="mistral", url="http://localhost:11434/api/generate"):
    if model == "gpt-4":
        ...
        data = {"model": model, "prompt": prompt, "context": context}
...
if __name__ == "__main__":
    ...
    print(
        llm(
            "Calculate the number of employees in each department. Here are the relevant tables and columns: appearances.csv, players.csv. Return only Python code and nothing else.",
